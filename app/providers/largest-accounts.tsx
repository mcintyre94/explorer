...
export function useFetchTokenLargestAccounts() {
  ...
  if (!dispatch) {
    throw new Error(`useFetchTokenLargestAccounts must be used within a LargestAccountsProvider`);
  }
...
export function useTokenLargestTokens(address: string): Cache.CacheEntry<LargestAccounts> | undefined {
  ...
  if (!context) {
    throw new Error(`useTokenLargestTokens must be used within a LargestAccountsProvider`);
  }
